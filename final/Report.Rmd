...
plot_confirmed_date <- {UKCaseData %>% ggplot(aes(x = date, y = daily_confirmed))} +
  ...
  scale_color_manual(labels = c("United Kingdom", "United States", "Mexico"), 
...
We look closer at the outliers in the trends for North & South America and identify that these are Nicaragua & Paraguay respectively.
