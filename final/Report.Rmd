...
In this report, we will be exploring the effects of lockdown and other government interventions on OmniCorp. Since our operations are primarily in Europe, and North, Central and South America, mainly concerning our stakes in the retail and hospitality sectors, we will be only looking at a subset of countries. We have been tasked with building an in house expertise on the ongoing COVID-19 virus outbreak. This report is our findings and recommendations to the company. 

The summary of our findings are as follows:

 * Number of confirmed cases impacts the severity of lockdown and government interventions imposed.
 * ...
